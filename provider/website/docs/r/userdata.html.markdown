...
sidebar_current: "docs-liviate-resource-user-data"
description: |-
...
```hcl
resource "liviate_user_data" "web_init" {
...
```hcl
resource "liviate_user_data" "app_init" {
...
```hcl
resource "liviate_user_data" "project_init" {
...
resource "liviate_template" "web_template" {
  ...
  userdata_link {
    userdata_id     = liviate_user_data.app_init.id
...
resource "liviate_instance" "web_server" {
  ...
  # ... other instance arguments ...
    ...
    userdata_id = liviate_user_data.app_init.id  # Pass parameter values to the userdata script
  userdata_details = {
...
```
terraform import liviate_user_data.example 12345678-1234-1234-1234-123456789012
```
