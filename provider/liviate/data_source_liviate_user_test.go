...
func TestAccUserDataSource_basic(t *testing.T) {
	resourceName := "liviate_user.user-resource"
	datasourceName := "data.liviate_user.user-data-source"
...
resource "liviate_user" "user-resource" {
  account = "admin"
...
data "liviate_user" "user-data-source"{
    ...
    depends_on = [
	  liviate_user.user-resource
	]
  }

output "user-output" {
  value = data.liviate_user.user-data-source
}
  `
