...
func TestAccIPAddressDataSource_basic(t *testing.T) {
	resourceName := "liviate_ipaddress.ipaddress-resource"
	datasourceName := "data.liviate_ipaddress.ipaddress-data-source"
...
resource "liviate_ipaddress" "ipaddress-resource" {
  ...
  data "liviate_ipaddress" "ipaddress-data-source"{
	  ...
	  depends_on = [
		liviate_ipaddress.ipaddress-resource
	  ]
	}
  
  output "ipaddress-output" {
	value = data.liviate_ipaddress.ipaddress-data-source
  }
  `
