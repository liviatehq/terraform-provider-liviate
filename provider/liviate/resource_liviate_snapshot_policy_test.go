		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackSnapshotPolicyExists("liviate_snapshot_policy.foo", &snapshotPolicy),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "interval_type", "DAILY"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "max_snaps", "7"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "schedule", "02:30"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "timezone", "UTC"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "tags.%", "2"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "tags.Environment", "test"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "tags.Purpose", "backup"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackSnapshotPolicyExists("liviate_snapshot_policy.hourly", &snapshotPolicy),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.hourly", "interval_type", "HOURLY"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.hourly", "max_snaps", "6"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.hourly", "schedule", "0"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.hourly", "timezone", "UTC"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.hourly", "custom_id", "test-hourly"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.hourly", "tags.%", "0"),
				),
			},
		},
	})
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackSnapshotPolicyExists("liviate_snapshot_policy.foo", &snapshotPolicy),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "max_snaps", "8"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "tags.Environment", "production"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.foo", "tags.Updated", "true"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackSnapshotPolicyExists("liviate_snapshot_policy.weekly", &snapshotPolicy),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.weekly", "interval_type", "WEEKLY"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.weekly", "schedule", "1:03:00"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.weekly", "tags.%", "0"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackSnapshotPolicyExists("liviate_snapshot_policy.monthly", &snapshotPolicy),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.monthly", "interval_type", "MONTHLY"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.monthly", "schedule", "15:01:00"),
					resource.TestCheckResourceAttr("liviate_snapshot_policy.monthly", "tags.%", "0"),
				),
			},
		},
	})
...
func testAccCheckCloudStackSnapshotPolicyDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "liviate_snapshot_policy" {
			continue
		}
...
resource "liviate_network" "foo" {
  ...
  zone = data.liviate_zone.zone.name
}
...
resource "liviate_disk_offering" "foo" {
...
resource "liviate_disk" "foo" {
  name             = "terraform-disk"
  attach           = true
  disk_offering    = liviate_disk_offering.foo.name
  virtual_machine_id = liviate_instance.foobar.id
  zone             = data.liviate_zone.zone.name
}

resource "liviate_snapshot_policy" "foo" {
  volume_id     = liviate_disk.foo.id
  interval_type = "DAILY"
  max_snaps     = 7
  schedule      = "02:30"
  timezone      = "UTC"
  zone_ids      = [data.liviate_zone.zone.id]
...
resource "liviate_snapshot_policy" "weekly" {
  volume_id     = liviate_disk.foo.id
...
resource "liviate_snapshot_policy" "monthly" {
  volume_id     = liviate_disk.foo.id
