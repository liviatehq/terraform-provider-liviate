		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_fixed.fixed1", "name", "fixed1"),
				),
			},
			{
				Config: testAccServiceOfferingFixed2,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_fixed.fixed2", "name", "fixed2"),
				),
			},
			{
				Config: testAccServiceOfferingFixed2_update,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_fixed.fixed2", "name", "fixed2update"),
				),
			},
			{
				Config: testAccServiceOfferingFixed_disk,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_fixed.disk", "name", "disk"),
				),
			},
			{
				Config: testAccServiceOfferingFixed_disk_hypervisor,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_fixed.disk_hypervisor", "name", "disk_hypervisor"),
				),
			},
			{
				Config: testAccServiceOfferingFixed_disk_storage,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_fixed.disk_storage", "name", "disk_storage"),
				),
			},
		},
	})
...
resource "liviate_service_offering_fixed" "fixed2" {
	display_text = "fixed2"
	name         = "fixed2"
...
resource "liviate_service_offering_fixed" "disk" {
	display_text = "disk"
	name         = "disk"
...
resource "liviate_service_offering_fixed" "disk_hypervisor" {
...
resource "liviate_service_offering_fixed" "disk_storage" {
