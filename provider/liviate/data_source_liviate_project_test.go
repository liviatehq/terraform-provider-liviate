...
func TestAccProjectDataSource_basic(t *testing.T) {
	resourceName := "liviate_project.project-resource"
	datasourceName := "data.liviate_project.project-data-source"
...
func TestAccProjectDataSource_withAccount(t *testing.T) {
	resourceName := "liviate_project.project-account-resource"
	datasourceName := "data.liviate_project.project-account-data-source"
...
resource "liviate_project" "project-resource" {
  name = "test-project-datasource"
  displaytext = "Test Project for Data Source"
}

data "liviate_project" "project-data-source" {
  filter {
    name = "name"
    value = "test-project-datasource"
  }
  depends_on = [
    liviate_project.project-resource
  ]
}

output "project-output" {
  value = data.liviate_project.project-data-source
}
`

const testProjectDataSourceConfig_withAccount = `
resource "liviate_project" "project-account-resource" {
...
data "liviate_project" "project-account-data-source" {
  filter {
    name = "name"
  ...
  depends_on = [
    liviate_project.project-account-resource
  ]
}

output "project-account-output" {
  value = data.liviate_project.project-account-data-source
}
`
