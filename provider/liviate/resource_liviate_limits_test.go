		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.foo"),
					resource.TestCheckResourceAttr(
						"liviate_limits.foo", "type", "instance"),
					resource.TestCheckResourceAttr(
						"liviate_limits.foo", "max", "10"),
				),
			},
		},
	})
...
resource "liviate_limits" "foo" {
  type         = "instance"
  max          = 10
  domain_id    = liviate_domain.test_domain.id
}
`
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.domain_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.domain_limit", "type", "volume"),
					resource.TestCheckResourceAttr(
						"liviate_limits.domain_limit", "max", "50"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.account_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.account_limit", "type", "snapshot"),
					resource.TestCheckResourceAttr(
						"liviate_limits.account_limit", "max", "100"),
				),
			},
		},
	})
...
// 				Check: resource.ComposeTestCheckFunc(
// 					testAccCheckCloudStackLimitsExists("liviate_limits.project_limit"),
// 					resource.TestCheckResourceAttr(
// 						"liviate_limits.project_limit", "type", "primarystorage"),
// 					resource.TestCheckResourceAttr(
// 						"liviate_limits.project_limit", "max", "1000"),
// 				),
// 			},
// 		},
// 	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.unlimited"),
					resource.TestCheckResourceAttr(
						"liviate_limits.unlimited", "type", "cpu"),
					resource.TestCheckResourceAttr(
						"liviate_limits.unlimited", "max", "-1"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.string_type"),
					resource.TestCheckResourceAttr(
						"liviate_limits.string_type", "type", "network"),
					resource.TestCheckResourceAttr(
						"liviate_limits.string_type", "max", "30"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.ip_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.ip_limit", "type", "ip"),
					resource.TestCheckResourceAttr(
						"liviate_limits.ip_limit", "max", "25"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.template_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.template_limit", "type", "template"),
					resource.TestCheckResourceAttr(
						"liviate_limits.template_limit", "max", "40"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.project_type_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.project_type_limit", "type", "project"),
					resource.TestCheckResourceAttr(
						"liviate_limits.project_type_limit", "max", "15"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.vpc_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.vpc_limit", "type", "vpc"),
					resource.TestCheckResourceAttr(
						"liviate_limits.vpc_limit", "max", "10"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.memory_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.memory_limit", "type", "memory"),
					resource.TestCheckResourceAttr(
						"liviate_limits.memory_limit", "max", "8192"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.zero_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.zero_limit", "type", "instance"),
					resource.TestCheckResourceAttr(
						"liviate_limits.zero_limit", "max", "0"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackLimitsExists("liviate_limits.secondarystorage_limit"),
					resource.TestCheckResourceAttr(
						"liviate_limits.secondarystorage_limit", "type", "secondarystorage"),
					resource.TestCheckResourceAttr(
						"liviate_limits.secondarystorage_limit", "max", "2000"),
				),
			},
		},
	})
...
func TestAccCloudStackLimits_import(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:            "liviate_limits.foo",
				ImportState:             true,
...
func TestAccCloudStackLimits_importDomain(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:            "liviate_limits.domain_limit",
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"domain_id", "type", "max", "configured_max"},
			},
...
func TestAccCloudStackLimits_importAccount(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:      "liviate_limits.account_limit",
				ImportState:       true,
...
resource "liviate_domain" "test_domain" {
  name = "test-domain-limits"
}
`

const testAccCloudStackLimits_domain_limit = `
resource "liviate_limits" "domain_limit" {
  type         = "volume"
  max          = 50
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_account" "test_account" {
...
resource "liviate_limits" "account_limit" {
  type         = "snapshot"
  max          = 100
  account      = liviate_account.test_account.username
  domain_id    = liviate_domain.test_domain.id
}
`

// const testAccCloudStackLimits_project = ` #TODO: Need project imported before this will do anything
// resource "liviate_project" "test_project" {
//   name         = "test-project-limits"
//   display_text = "Test Project for Limits"
//   domain_id    = liviate_domain.test_domain.id
// }
//
// resource "liviate_limits" "project_limit" {
//   type         = "primarystorage"
//   max          = 1000
//   domain_id    = liviate_domain.test_domain.id
//   projectid    = liviate_project.test_project.id
// }
// `

const testAccCloudStackLimits_unlimited = `
resource "liviate_limits" "unlimited" {
  type         = "cpu"
  max          = -1
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_limits" "string_type" {
  type         = "network"
  max          = 30
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_limits" "ip_limit" {
  type         = "ip"
  max          = 25
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_limits" "template_limit" {
  type         = "template"
  max          = 40
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_limits" "project_type_limit" {
  type         = "project"
  max          = 15
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_limits" "vpc_limit" {
  type         = "vpc"
  max          = 10
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_limits" "memory_limit" {
  type         = "memory"
  max          = 8192
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_limits" "zero_limit" {
  type         = "instance"
  max          = 0
  domain_id    = liviate_domain.test_domain.id
}
...
resource "liviate_limits" "secondarystorage_limit" {
...
resource "liviate_limits" "positive_limit" {
  type         = "instance"
  max          = 15
  domain_id    = liviate_domain.test_domain.id
}
