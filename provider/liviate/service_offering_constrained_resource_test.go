		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_constrained.constrained1", "name", "constrained1"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_constrained.constrained2", "name", "constrained2"),
				),
			},
			{
				Config: testAccServiceOfferingCustomConstrained2_update,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_constrained.constrained2", "name", "constrained2update"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_constrained.disk_hypervisor", "name", "disk_hypervisor"),
				),
			},
			{
				Config: testAccServiceOfferingCustomConstrained_disk_storage,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_constrained.disk_storage", "name", "disk_storage"),
				),
			},
		},
	})
...
resource "liviate_service_offering_constrained" "constrained1" {
...
resource "liviate_service_offering_constrained" "constrained2" {
...
resource "liviate_service_offering_constrained" "disk_hypervisor" {
...
resource "liviate_service_offering_constrained" "disk_storage" {
