		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackEgressFirewallRulesExist("liviate_egress_firewall.foo"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.#", "1"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.0.cidr_list.0", "10.1.1.10/32"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.0.protocol", "tcp"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.0.ports.0", "8080"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
...

			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackEgressFirewallRulesExist("liviate_egress_firewall.foo"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.#", "2"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.0.cidr_list.0", "10.1.1.10/32"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.0.cidr_list.1", "10.1.1.11/32"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.0.protocol", "tcp"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.0.ports.0", "8080"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.1.cidr_list.0", "10.1.1.10/32"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.1.protocol", "tcp"),
					resource.TestCheckResourceAttr(
						"liviate_egress_firewall.foo", "rule.1.ports.1", "80"),
				),
			},
		},
	})
...
func testAccCheckCloudStackEgressFirewallDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "liviate_egress_firewall" {
			continue
		}
...
resource "liviate_egress_firewall" "foo" {
