...
func TestAccServiceOfferingDataSource_basic(t *testing.T) {
	resourceName := "liviate_service_offering.service-offering-resource"
	datasourceName := "data.liviate_service_offering.service-offering-data-source"
...
resource "liviate_service_offering" "service-offering-resource" {
...
data "liviate_service_offering" "service-offering-data-source" {
	...
	depends_on = [liviate_service_offering.service-offering-resource]
}
`
