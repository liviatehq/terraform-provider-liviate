		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackTemplateExists("liviate_template.foo", &template),
					testAccCheckCloudStackTemplateBasicAttributes(&template),
					resource.TestCheckResourceAttr(
						"liviate_template.foo", "display_text", "terraform-test"),
...

			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackTemplateExists(
						"liviate_template.foo", &template),
					testAccCheckCloudStackTemplateUpdatedAttributes(&template),
					resource.TestCheckResourceAttr(
						"liviate_template.foo", "display_text", "terraform-updated"),
				),
			},
		},
	})
