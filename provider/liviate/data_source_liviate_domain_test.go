...
func TestAccCloudstackDomainDataSource_basic(t *testing.T) {
	resourceName := "data.liviate_domain.my_domain"
...
func TestAccCloudstackDomainDataSource_byID(t *testing.T) {
	domainResourceName := "liviate_domain.test_domain"
	dataSourceName := "data.liviate_domain.my_domain_by_id"
...
data "liviate_domain" "my_domain_by_id" {
  filter {
    name  = "id"
    value = liviate_domain.test_domain.id
  }
}
`, domainName)
}
