		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists(
						"liviate_instance.foobar", &instance),
					testAccCheckCloudStackInstanceAttributes(&instance),
					resource.TestCheckResourceAttr(
						"liviate_instance.foobar", "user_data", "0cf3dcdc356ec8369494cb3991985ecd5296cdd5"),
		...
		Steps: []resource.TestStep{
...

			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"liviate_instance.foobar", "name", "terraform-updated"),
					resource.TestCheckResourceAttr(
						"liviate_instance.foobar", "display_name", "terraform-updated"),
					resource.TestCheckResourceAttr(
						"liviate_instance.foobar", "service_offering", "Medium Instance"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists(
						"liviate_instance.foobar", &instance),
					resource.TestCheckResourceAttr(
						"liviate_instance.foobar", "ip_address", "10.1.1.123"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists(
						"liviate_instance.foobar", &instance),
					resource.TestCheckResourceAttr(
						"liviate_instance.foobar", "keypair", "terraform-test-keypair"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists("liviate_instance.foobar", &instance),
					resource.TestCheckResourceAttr("liviate_instance.foobar", "keypairs.#", "2"), // Expecting 2 key pairs
					resource.TestCheckResourceAttr("liviate_instance.foobar", "keypairs.0", "terraform-test-keypair-foo"),
					resource.TestCheckResourceAttr("liviate_instance.foobar", "keypairs.1", "terraform-test-keypair-bar"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackInstanceExists(
						"liviate_instance.foobar", &instance),
					resource.TestCheckResourceAttr(
						"liviate_instance.foobar", "project", "terraform"),
				),
			},
		},
	})
...
func TestAccCloudStackInstance_import(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:            "liviate_instance.foobar",
				ImportState:             true,
...
resource "liviate_ssh_keypair" "foo" {
...
resource "liviate_instance" "foobar" {
  ...
  template = "CentOS 5.6 (64-bit) no GUI (Simulator)"
  zone = "Sandbox-simulator"
  keypair = liviate_ssh_keypair.foo.name
  expunge = true
}`
...
resource "liviate_ssh_keypair" "bar" {
...
resource "liviate_instance" "foobar" {
  ...
  template = "CentOS 5.6 (64-bit) no GUI (Simulator)"
  zone = "Sandbox-simulator"
  keypairs = ["${liviate_ssh_keypair.foo.name}", "${liviate_ssh_keypair.bar.name}"]
  expunge = true
}`
