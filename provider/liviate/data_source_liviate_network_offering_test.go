...
func TestAccNetworkOfferingDataSource_basic(t *testing.T) {
	resourceName := "liviate_network_offering.net-off-resource"
	datasourceName := "data.liviate_network_offering.net-off-data-source"
...
resource "liviate_network_offering" "net-off-resource"{
  ...
  data "liviate_network_offering" "net-off-data-source"{
    ...
    value="TestNetworkDisplay01"
	  ...
	  depends_on = [
	  liviate_network_offering.net-off-resource
	]
  }
  `
