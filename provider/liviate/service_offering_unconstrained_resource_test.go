		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_unconstrained.unconstrained1", "name", "unconstrained1"),
				),
			},
			{
				Config: testAccServiceOfferingUnconstrained2,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_unconstrained.unconstrained2", "name", "unconstrained2"),
				),
			},
			{
				Config: testAccServiceOfferingUnconstrained2_update,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_unconstrained.unconstrained2", "name", "unconstrained2update"),
				),
			},
			{
				Config: testAccServiceOfferingUnconstrained_disk,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_unconstrained.disk", "name", "disk"),
				),
			},
			{
				Config: testAccServiceOfferingUnconstrained_disk_hypervisor,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_unconstrained.disk_hypervisor", "name", "disk_hypervisor"),
				),
			},
			{
				Config: testAccServiceOfferingUnconstrained_disk_storage,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_service_offering_unconstrained.disk_storage", "name", "disk_storage"),
				),
			},
		},
	})
...
resource "liviate_service_offering_unconstrained" "unconstrained2" {
...
resource "liviate_service_offering_unconstrained" "disk" {
	display_text = "disk"
	name         = "disk"
...
resource "liviate_service_offering_unconstrained" "disk_hypervisor" {
...
resource "liviate_service_offering_unconstrained" "disk_storage" {
