		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackPortForwardsExist("liviate_port_forward.foo"),
					resource.TestCheckResourceAttr(
						"liviate_port_forward.foo", "forward.#", "1"),
					resource.TestCheckResourceAttrSet(
						"liviate_port_forward.foo", "forward.0.uuid"),
					resource.TestCheckResourceAttr(
						"liviate_port_forward.foo", "forward.0.protocol", "tcp"),
					resource.TestCheckResourceAttr(
						"liviate_port_forward.foo", "forward.0.private_port", "443"),
					resource.TestCheckResourceAttr(
						"liviate_port_forward.foo", "forward.0.public_port", "8443"),
					resource.TestCheckResourceAttrSet(
						"liviate_port_forward.foo", "forward.0.virtual_machine_id"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
...

			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackPortForwardsExist("liviate_port_forward.foo"),
					resource.TestCheckResourceAttr(
						"liviate_port_forward.foo", "forward.#", "2"),
					...
					resource.TestCheckResourceAttrSet(
						"liviate_port_forward.foo", "forward.1.uuid"),
					resource.TestCheckResourceAttr(
						"liviate_port_forward.foo", "forward.1.protocol", "tcp"),
					resource.TestCheckResourceAttrSet(
						"liviate_port_forward.foo", "forward.1.virtual_machine_id"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"liviate_port_forward.foo", "forward.#", "2"),
					testAccCheckCloudStackPortForwardAttributes("liviate_port_forward.foo"),
...
func testAccCheckCloudStackPortForwardDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "liviate_port_forward" {
			continue
		}
...
resource "liviate_port_forward" "foo" {
