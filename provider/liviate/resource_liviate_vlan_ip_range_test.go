		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "gateway", "10.0.0.1"),
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "netmask", "255.255.255.0"),
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "start_ip", "10.0.0.2"),
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "end_ip", "10.0.0.10"),
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "vlan", "vlan://123"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "netmask", "255.255.255.0"),
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "start_ip", "10.0.0.2"),
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "end_ip", "10.0.0.20"),
					resource.TestCheckResourceAttr("liviate_vlan_ip_range.test", "vlan", "vlan://123"),
				),
			},
		},
