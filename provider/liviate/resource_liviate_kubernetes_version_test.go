		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackKubernetesVersionExists("liviate_kubernetes_version.foo", &version),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"liviate_kubernetes_version.foo", "state", "Enabled"),
				),
			},

			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckCloudStackKubernetesVersionAttributes(&version),
					resource.TestCheckResourceAttr(
						"liviate_kubernetes_version.foo", "state", "Disabled"),
				),
			},
		},
	})
...
func testAccCheckCloudStackKubernetesVersionDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "liviate_kubernetes_version" {
			continue
		}
...
resource "liviate_kubernetes_version" "foo" {
