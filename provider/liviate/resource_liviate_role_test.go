		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackRoleExists("liviate_role.foo", &role),
					resource.TestCheckResourceAttr(
						"liviate_role.foo", "name", "terraform-role"),
					resource.TestCheckResourceAttr(
						"liviate_role.foo", "description", "terraform test role"),
					resource.TestCheckResourceAttr(
						"liviate_role.foo", "is_public", "true"),
				),
			},
		},
	})
