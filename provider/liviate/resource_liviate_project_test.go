		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackProjectExists(
						"liviate_project.foo", &project),
					resource.TestCheckResourceAttr(
						"liviate_project.foo", "name", "terraform-test-project"),
					resource.TestCheckResourceAttr(
						"liviate_project.foo", "displaytext", "Terraform Test Project"),
				),
			},
		},
	})
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackProjectExists(
						"liviate_project.foo", &project),
					resource.TestCheckResourceAttr(
						"liviate_project.foo", "name", "terraform-test-project-updated"),
					resource.TestCheckResourceAttr(
						"liviate_project.foo", "displaytext", "Terraform Test Project Updated"),
				),
			},
		},
	})
...
func TestAccCloudStackProject_import(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:      "liviate_project.foo",
				ImportState:       true,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackProjectExists(
						"liviate_project.bar", &project),
					resource.TestCheckResourceAttr(
						"liviate_project.bar", "name", "terraform-test-project-account"),
					resource.TestCheckResourceAttr(
						"liviate_project.bar", "displaytext", "Terraform Test Project with Account"),
					resource.TestCheckResourceAttr(
						"liviate_project.bar", "account", "admin"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackProjectExists(
						"liviate_project.empty", &project),
					resource.TestCheckResourceAttr(
						"liviate_project.empty", "name", "terraform-test-project-empty-display"),
					resource.TestCheckResourceAttr(
						"liviate_project.empty", "displaytext", "terraform-test-project-empty-display"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackProjectExists(
						"liviate_project.baz", &project),
					resource.TestCheckResourceAttr(
						"liviate_project.baz", "name", "terraform-test-project-userid"),
					resource.TestCheckResourceAttr(
						"liviate_project.baz", "displaytext", "Terraform Test Project with Userid"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackProjectExists(
						"liviate_project.baz", &project),
					resource.TestCheckResourceAttr(
						"liviate_project.baz", "name", "terraform-test-project-userid-updated"),
					resource.TestCheckResourceAttr(
						"liviate_project.baz", "displaytext", "Terraform Test Project with Userid Updated"),
				),
			},
		},
	})
...
resource "liviate_project" "empty" {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackProjectExists(
						"liviate_project.accountid_test", &project),
					resource.TestCheckResourceAttr(
						"liviate_project.accountid_test", "name", "terraform-test-project-accountid"),
					resource.TestCheckResourceAttr(
						"liviate_project.accountid_test", "displaytext", "Terraform Test Project with Accountid"),
					resource.TestCheckResourceAttrSet(
						"liviate_project.accountid_test", "accountid"),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCloudStackProjectsExist("liviate_project.project1", "liviate_project.project2"),
				),
			},
		},
	})
...
resource "liviate_project" "accountid_test" {
