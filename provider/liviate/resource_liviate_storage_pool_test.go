...
func TestAccCloudStackStoragePool_basic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// 		resource.TestCheckResourceAttr("liviate_storage_pool.test", "name", "accprimarystorage1"),
			// 	),
			// },
		},
	})
...
resource "liviate_cluster" "test" {
	cluster_name = "acc_cluster"
	cluster_type = "CloudManaged"
	hypervisor   = "KVM"
	pod_id       = liviate_pod.test.id
	zone_id      = liviate_zone.test.id
}
`

// resource "liviate_storage_pool" "test" {
// 	name         = "acc_primarystorage"
// 	url          = "nfs://10.147.28.6/export/home/sandbox/primary11"
// 	zone_id      = liviate_zone.test.id
// 	cluster_id   = liviate_cluster.test.id
// 	pod_id       = liviate_pod.test.id
// 	scope        = "CLUSTER"
